...
const data = [
  ...
  {
    id: 3,
    title: 'Great Service, Steal of a price',
    description:
      'Working with them was a treat. The support is quick and really helpful, the videos are high quality, and the prices are wonderful. Recommended.',
  ...
  return (
    <section id="testimonial" sx={{ variant: 'section.testimonial' }}>
      <Container css={{ textAlign: 'center' }}>
        <SectionHeader slogan="Testimonials" title="Assured Client Satisfaction" />
      </Container>
